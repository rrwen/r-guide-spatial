...
Sometimes, the data file is not in a spatial format such as `.geojson` or `.shp`, but coordinates such as longitude and latitude is given along with what the Coordinate Reference System (CRS) is.

For these cases, we can first first read in the non-spatial data normally.
